...
public class Main
{
	...
	public static void main(final String[] args) throws JCoException, FileNotFoundException, UnsupportedEncodingException
	{
		/*final TaskSchedule schedule = new TaskSchedule();
		final List<Task> tasks = schedule.nextTask("10", "10");
